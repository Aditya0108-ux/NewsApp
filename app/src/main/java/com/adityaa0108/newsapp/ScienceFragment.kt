...
class ScienceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.sciencefragment,container,false)
        val recyclerView = view?.findViewById<RecyclerView>(R.id.sciencerecycleview)
        list = ArrayList()
    ...
    fun findNews(){
        RetrofitInstance.apiInterface.getCategoryNews(country, category ,100,api).enqueue(object : Callback<MainNews> {
